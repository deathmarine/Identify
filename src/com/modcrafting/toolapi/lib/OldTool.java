...
public class OldTool extends CraftItemStack implements ToolInterface
{
    public OldTool(ItemStack item)
    {
        super(item);
        tag();
    }

    public OldTool(Material mat)
    {
        super(mat, 1);
        tag();
    }

    public OldTool(org.bukkit.inventory.ItemStack source)
    {
